...
const routes: Routes = [
    ...
    {path: 'environment-universitaire', component: EnivronnementUniversitaireComponent},
    {path: 'environment-universitaire/Institus', component: InstitusComponent},
    {path: 'environment-universitaire/Institus/:id', component: OneInstitusComponent},
    {path: 'environment-universitaire/Clubs', component: ClubsComponent},
    {path: 'environment-universitaire/Clubs/:id', component: OneClubComponent},
